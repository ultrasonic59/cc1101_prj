...
///==============================================
confirm_state usart_transmitter_enabled(usart_type* usart_x)
{
 return  (confirm_state)usart_x->ctrl1_bit.ten;
}
...
///============================================
confirm_state usart_receiver_enabled(usart_type* usart_x)
{
return (confirm_state)usart_x->ctrl1_bit.ren;
}
